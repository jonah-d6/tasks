...
export function makeBlankQuestion(
    ...
    return {id: id, name: name, type: type, body: "", expected: "", options: [],
      points:1, published:false};
}
...
export function isValid(question: Question, answer: string): boolean {
    return question.type==="short_answer_question"? true :
...
export function duplicateQuestion(id: number, oldQuestion: Question): Question {
    return {...oldQuestion,
      id:id, name:"Copy of " + oldQuestion.name, published:false};
}
...
export function mergeQuestion(
    ...
    return {...contentQuestion, id:id, name:name, published:false,
